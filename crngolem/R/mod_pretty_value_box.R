...
F_PRETTY_VALUE_BOX_TEMPLATE <- "inst/app/www/pretty_val_box_index.html"
...
pretty_value_box_ui <- function(id, background_color = "#e2a267", icon_name = "question-circle") {
  ...
  htmlTemplate(
    ...
    inline_bar = sparkline::sparklineOutput(ns("inline_bar"), width = "300px") %>%
      shinycssloaders::withSpinner(proxy.height = "50px", size = 0.5, type = 1, color = "#EEEEEE"),
