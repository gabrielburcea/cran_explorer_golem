    ...
    fluidRow(
      ...
      column(
        ...
        fluidRow(
          ...
          column(
            width = 6,
            shinyWidgets::switchInput(ns("graph_physics_enabled"), label = "Layout", value = FALSE, size = "mini"),
          ...
          column(
            ...
            div(
              visNetwork::visNetworkOutput(ns("graph"), width = "100%", height = "450px"),
              style = "margin-top: -180px"
            )
          )
        ),
        ...
        fluidRow(
          column(
            ...
            uiOutput(ns("package_info")) %>%
              shinycssloaders::withSpinner(type = 6, size = 0.5, proxy.height = "200px")
          ),
          column(
            width = 12,
            highcharter::highchartOutput(ns("plot_pkg_downloads"), height = 200) %>%
              shinycssloaders::withSpinner(type = 6, size = 0.5, proxy.height = "200px")
          )
        )
      )
